...
export function FileUploader() {
  ...
  const onDrop = useCallback(
    async (acceptedFiles: File[]) => {
      ...
      try {
        ...
        const datasetType = (result.metadata?.type || "general") as
          | "financial"
          | "inventory"
          | "sales"
          | "hr"
        ...
        const detailedSummary =
          tableNames.length > 0 ? await generateDatasetSummary(tableNames, datasetType) : result.summary
      ...
      case "error":
        return (
          <div className="space-y-4">
            ...
            <Button onClick={() => setUploadState({ status: "idle", progress: 0 })} variant="outline">
              Try Again
            </Button>
          </div>
        )
      ...
      default:
        return (
          <div className="space-y-4">
            ...
            <Button variant="outline" className="hover:bg-muted/80 transition-colors bg-transparent">
              Browse Files
            </Button>
          </div>
        )
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto border-border/40 shadow-lg shadow-black/5 bg-card/50 backdrop-blur-sm card-hover">
          ...
          className={`
            ...
            ${
              isDragActive
                ...
                : "border-border/60 hover:border-accent/60 hover:bg-muted/20 hover:shadow-md hover:shadow-black/5"
            }
